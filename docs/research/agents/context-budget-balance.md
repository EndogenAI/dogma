...
- [`docs/research/values-encoding.md`](../methodology/values-encoding.md) — Full synthesis read. Pattern 7 (Retrieval-Augmented Governance) and R2 (4-form encoding increases volume) are the direct endogenous inputs to this research question. The [4,1] repetition code (Pattern 1) governs the compression risk analysis.
