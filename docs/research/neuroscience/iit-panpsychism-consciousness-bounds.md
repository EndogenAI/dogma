...
> **Date**: 2026-03-10
> **Related**: [`docs/research/endogenic-design-paper.md`](../methodology/endogenic-design-paper.md) (augmentative partnership principle; human-system co-cognition); [`MANIFESTO.md`](../../../MANIFESTO.md) (how axioms encode human judgment)
