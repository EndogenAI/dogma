...
> **Date**: 2026-03-10
> **Closes**: #170
> **Related**: [`docs/research/bubble-clusters-substrate.md`](bubble-clusters-substrate.md) (membrane topology); [`docs/research/values-encoding.md`](../methodology/values-encoding.md) (values layer connectivity)
...
- [`docs/research/enforcement-tier-mapping.md`](../methodology/enforcement-tier-mapping.md) — constraint tier classification (T0–T5)
