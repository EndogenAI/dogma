...
> **Related**: [`docs/research/external-value-architecture.md`](../methodology/external-value-architecture.md) (six-layer core model); [`docs/research/bubble-clusters-substrate.md`](bubble-clusters-substrate.md) (boundary membrane dynamics); [`docs/research/values-encoding.md`](../methodology/values-encoding.md) (inheritance chain foundation)
...
**Action**: Implement the conflict taxonomy, decision tree (ALLOW/BLOCK/ESCALATE), and conflict logging from [`docs/research/external-values-decision-framework.md`](../methodology/external-values-decision-framework.md). Create a reusable script that agents can invoke to resolve apparent conflicts between layers:
```python
...
### [external-value-architecture.md](../methodology/external-value-architecture.md) — Four-Layer Value Hierarchy with Supremacy Rule
...
### [values-encoding.md](../methodology/values-encoding.md) — Inheritance Chain and Re-Encoding Loss at Boundaries
