...
- Cross-reference: [`docs/research/agent-fleet-design-patterns.md`](../agents/agent-fleet-design-patterns.md) — Compression-on-Ascent / Focus-on-Descent findings apply directly to agent team topology mapping
