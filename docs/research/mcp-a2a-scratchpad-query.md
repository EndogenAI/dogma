...
not fleet scale. This aligns with the **MANIFESTO.md §2** ([MANIFESTO.md §2](../../MANIFESTO.md#2-algorithms-before-tokens)) axiom: encoding
...
is sufficient. The [MANIFESTO.md §1](../../MANIFESTO.md#1-endogenous-first) axiom supports encoding this trust signal
...
dogma session format. The [MANIFESTO.md §2](../../MANIFESTO.md#2-algorithms-before-tokens) axiom is directly
...
These controls are sufficient for the local stdio threat model. The [MANIFESTO.md §1](../../MANIFESTO.md#1-endogenous-first) axiom supports encoding these as enforced schema constraints (MCP annotations +
