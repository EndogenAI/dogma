...
> **Date**: 2026-03-10
> **Related**: [`session-management.md`](../../guides/session-management.md) (scratchpad compaction protocol); [`docs/research/bubble-clusters-substrate.md`](../neuroscience/bubble-clusters-substrate.md) (topological substrate model); [`AGENTS.md`](../../AGENTS.md) (context-window guardrails)
