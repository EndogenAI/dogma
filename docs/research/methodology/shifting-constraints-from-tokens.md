...
- [docs/research/programmatic-governors.md](../infrastructure/programmatic-governors.md) — Phase 2 foundational synthesis. Governor tier definitions and Watt governor analogy; forms theoretical foundation for layered enforcement concepts in this document.
