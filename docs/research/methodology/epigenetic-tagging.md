...
> **Related**: [`docs/research/values-encoding.md`](values-encoding.md) §5 OQ-VE-2 (source of the regulatory-region gap); [`docs/research/bubble-clusters-substrate.md`](../neuroscience/bubble-clusters-substrate.md) (boundary-membrane model — epigenetic tagging is boundary-permeability calibration)
