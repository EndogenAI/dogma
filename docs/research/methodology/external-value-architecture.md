...
> **Related**: [`docs/research/values-encoding.md`](values-encoding.md) (inheritance chain foundation); [`docs/research/bubble-clusters-substrate.md`](../neuroscience/bubble-clusters-substrate.md) (boundary-membrane model for inter-layer signal dynamics)
