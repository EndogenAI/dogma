...
> **Date**: 2026-03-12
> **Research Issue**: #211
> **Related**: [`docs/research/values-encoding.md`](../methodology/values-encoding.md) (F4 gap origin);
> [`docs/research/programmatic-governors.md`](programmatic-governors.md) (governor tier taxonomy);
> [`docs/research/enforcement-tier-mapping.md`](../methodology/enforcement-tier-mapping.md) (T0–T5 audit);
...
- [Vocabulary Bridge: Encoding Models](../methodology/vocabulary-bridge-encoding-models.md) — shared vocabulary bridging the vertical (values-encoding) and horizontal (bubble-clusters-substrate) encoding models; bridge terms relevant to LCF enforcement design
