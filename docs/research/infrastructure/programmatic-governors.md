...
> **Status**: Final — Foundational synthesis. See [shifting-constraints-from-tokens.md](../methodology/shifting-constraints-from-tokens.md) for deep architectural research on enforcement stacks and pattern catalogs.
...
> **Date**: 2026-03-10
> **Related**: [`docs/research/values-encoding.md`](../methodology/values-encoding.md) (value degradation and programmatic encoding as drift-immune layer); [`docs/research/deterministic-agent-components.md`](../agents/deterministic-agent-components.md)
...
- [`docs/research/values-encoding.md`](../methodology/values-encoding.md) — H1 (value degradation patterns), H3 (programmatic encoding immune to semantic drift).
