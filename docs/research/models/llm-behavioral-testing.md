...
> **Related**: [`docs/research/values-encoding.md`](../methodology/values-encoding.md) §5 OQ-VE-4 (source question); [`docs/research/bubble-clusters-substrate.md`](../neuroscience/bubble-clusters-substrate.md) (boundary-membrane model — value fidelity testing is boundary health monitoring); [`docs/research/epigenetic-tagging.md`](../methodology/epigenetic-tagging.md)
