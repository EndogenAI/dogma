...
- [ ] D4 `docs/research/agent-fleet-design-patterns.md` committed with `Status: Final`
- [ ] All 3 design hypotheses explicitly validated or contradicted with evidence
- [ ] Named pattern catalog (≥ 4 patterns) present in D4
- [ ] `docs/guides/agents.md` updated with specialist-vs-extend decision heuristics
- [ ] `.github/agents/README.md` updated with pattern documentation
- [ ] Issue #10 closed with link to committed D4
