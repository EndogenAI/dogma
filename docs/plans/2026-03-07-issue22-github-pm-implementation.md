...
- [ ] R1: 21 namespaced labels on GitHub, 10 legacy defaults deleted
- [ ] R2: Project "EndogenAI Backlog" (#1) has Priority field; existing issues added
- [ ] R3: All 3 YAML templates have `projects: ["EndogenAI/1"]`
- [ ] R4: `.github/workflows/labeler.yml` + `.github/labeler.yml` exist and correct ✅
- [ ] R5: `.github/workflows/stale.yml` exists and correct ✅
- [ ] R6: `gh auth refresh -s project` documented in `CONTRIBUTING.md` ✅
- [ ] Issue #22 closed
