...
**Closes**: [#12 — [Research] XML-Tagged Agent Instruction Format](https://github.com/EndogenAI/dogma/issues/12)
...
**Depends on**: nothing
**Status**: ✅ Complete — 14 sources across 5 frameworks
...
**Status**: ✅ Complete — 9 new sources fetched, 7 reused from cache
...
**Status**: ✅ Complete — 9 D3s committed at 317d3b7
...
**Status**: ✅ Complete — 637 lines, docs/research/xml-agent-instruction-format.md
...
**Depends on**: Phase 4
**Status**: ✅ Complete — PASS verdict, S1 applied (LM API caveat in §1)
...
**Status**: ✅ Complete — D4 at Status: Final, committed 9f7949c, issue #12 CLOSED

---

## Acceptance Criteria

- [x] D1 manifest lists ≥ 8 sources spanning ≥ 3 frameworks
- [x] D2s exist in `.cache/sources/` for every source in D1
- [x] D3s committed in `docs/research/sources/` for every D2, using full 8-section template
- [x] D4 `docs/research/xml-agent-instruction-format.md` committed with `Status: Final`
- [x] D4 includes a Framework Comparison Table and a Reference Card section
- [x] Issue #12 closed with link to committed D4
