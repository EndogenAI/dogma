...
Coverage groups:
    ...
    - dogma_server.py: importable + mcp instance exists with 9 tools registered
"""
...
class TestDogmaServerImport:
    ...
    def test_server_registers_nine_tools(self):
        """The mcp server should register exactly 9 tools."""
        import importlib
