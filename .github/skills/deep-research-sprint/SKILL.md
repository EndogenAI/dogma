...
This skill is governed by [`AGENTS.md`](../../AGENTS.md). The research fleet and orchestration pattern are described in [`.github/agents/README.md`](../README.md). The D4 document quality standard is enforced by `validate_synthesis.py`. When this skill and `AGENTS.md` conflict, `AGENTS.md` takes precedence.
