...
3. [`docs/research/comms-marketing-bizdev.md`](../../docs/research/comms-marketing-bizdev.md) — the research basis for this agent's work; read all findings and open questions.
