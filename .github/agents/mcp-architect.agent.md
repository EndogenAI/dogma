...
3. [`docs/research/agentic-research-flows.md`](../../docs/research/agentic-research-flows.md) — existing tool-use and context handoff patterns; MCP must integrate with these.
4. [`docs/research/agent-fleet-design-patterns.md`](../../docs/research/agent-fleet-design-patterns.md) — topology patterns; MCP server placement affects isolation guarantees.
