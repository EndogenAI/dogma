...
2. [`docs/research/product-research-and-design.md`](../../docs/research/product-research-and-design.md) — primary research backing for this agent's methodology; JTBD applicability to OSS tools confirmed in H1 and H3.
3. [`docs/research/pm-and-team-structures.md`](../../docs/research/pm-and-team-structures.md) — label taxonomy and GitHub Discussions conventions referenced in synthesis.
